...
export default function TopNavbar() {
  ...
  return (
    <>
      ...
      <Wrapper className="flexCenter animate whiteBg" style={y > 100 ? { height: "60px", background:'#1FA2FF' } : { height: "80px"}}>
        <NavInner className="container flexSpaceCenter">
          ...
          <UlWrapper className="flexNullCenter">
            <li className="semiBold font15 pointer">
              <Link activeClass="active" style={{ padding: "10px 15px", color: "#fff" }} to="home" spy={true} smooth={true} offset={-80}>
              Profil
              </Link>
            </li>
            <li className="semiBold font15 pointer">
